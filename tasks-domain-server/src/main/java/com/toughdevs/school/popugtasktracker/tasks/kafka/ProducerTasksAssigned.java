...
@Service
public class ProducerTasksAssigned {

  private static final Logger logger = LoggerFactory.getLogger(ProducerTasksAssigned.class);
  private static final String TOPIC = "tasks.assigned";
